...
export const certifications: Certification[] = [
  ...
  {
    slug: "nptel-cs",
    title: "NPTEL Course Certification",
    issuer: "NPTEL / SWAYAM",
    domain: "Computer Science",
    file: "/certificates/nptel.pdf",
    description: "Rigorous academic certification from the National Programme on Technology Enhanced Learning, validating deep understanding of core Computer Science principles and algorithms.",
    skills: ["Computer Science Fundamentals", "Data Structures", "Algorithms", "Problem Solving"],
  },
  {
    slug: "nse-blockchain",
  ...
  {
    slug: "infosys-certification",
    title: "Infosys Certification",
    issuer: "Infosys Springboard",
    domain: "Technology",
    file: "/certificates/infosys.pdf",
    description: "Certification covering modern software engineering practices, agile methodologies, and full-stack development principles tailored for enterprise IT environments.",
    skills: ["Software Engineering", "Agile Methodologies", "Enterprise IT", "Full-Stack Concepts"],
  },
  {
